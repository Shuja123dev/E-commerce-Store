...
function AboutComp() {
  return (
    <>
        <section className="about-banner flex-box">
            <h3>About</h3>
        </section>

        <section className="mission-section flex-box">
            <div className="mission-container max-box">
                <div className="mission-cont mission-box">
                    <div className="mission-content">
                        <div className="miss-content-box">
                        ...
                        <div className="mission-img-box flex-box">
                            <div className="mission-img">
                                <div className='img-border2'>
                                    <img className='storyimg2' src={require('../about/story.png')} alt=""/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mission-cont mission-box">
                    <div className="story-content">
                        <div className="mission-img-box flex-box">
                            <div className="mission-img">
                                <div className='img-border2'>
                                    <img src={require('../about/mission.png')} alt=""/>
                                </div>
                            </div>
                        </div>
                        <div className="miss-content-box">
